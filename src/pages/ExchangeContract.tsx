              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-amber-900 leading-relaxed">
                    Подписывая настоящий Договор, Клиент заявляет и гарантирует, что денежные средства,
                    передаваемые для обмена, <strong>получены законным путём</strong> и не являются результатом
                    преступной деятельности, мошенничества, уклонения от уплаты налогов или иных
                    противоправных действий. Клиент несёт полную ответственность за достоверность данного
