  ...
  return (
    <div className="space-y-16 max-w-6xl mx-auto">
      ...
      <div className="text-center space-y-6 py-8">
        <h2 className="text-5xl font-bold text-gray-800 leading-tight">Мгновенный обмен<br/>криптовалют</h2>
      ...
      <div>
        <h3 className="text-3xl font-bold text-center text-gray-800 mb-10">Почему выбирают нас</h3>
        <div className="grid grid-cols-3 gap-6">
          {[
            ...
            <div key={feature.title} className="rounded-2xl border border-gray-200 bg-white p-8">
              ...
              <p className="font-bold text-gray-800 text-xl mb-2">{feature.title}</p>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-12">
        <h3 className="text-3xl font-bold text-center text-gray-800 mb-12">Как это работает</h3>
        <div className="grid grid-cols-3 gap-12">
          {[
            ...
            <div key={s.step} className="text-center">
              ...
              <p className="text-xl font-bold text-gray-800 mt-2">{s.title}</p>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-12">
        <h3 className="text-3xl font-bold text-center text-gray-800 mb-8">Поддерживаемые криптовалюты</h3>
        ...
        <div className="grid grid-cols-5 gap-4">
          {COINS_LIST.map(coin => (
            <div key={coin.symbol} className="flex items-center gap-3 px-5 py-4 bg-neutral-50 border border-gray-200 rounded-xl hover:border-gray-300 hover:shadow-sm transition-all">
              ...
              <div>
                <span className="font-bold text-base text-gray-800 block">{coin.rateKey}</span>
