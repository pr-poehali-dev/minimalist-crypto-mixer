  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        ...
        'hover:bg-gray-200 hover:text-foreground focus:bg-gray-200 focus:text-foreground',
        'data-[highlighted=true]:bg-gray-200 data-[highlighted=true]:text-foreground',
        inset && 'ps-7',
        variant === 'destructive' &&
